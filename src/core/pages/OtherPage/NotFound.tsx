// src/cms/pages/OtherPage/NotFound.tsx
import GridShape from "@/core/components/common/GridShape";
...
export default function NotFound() {
  return (
    <>
      ...
      />
      <div className="bg-gray-50 dark:bg-gray-900 cursor-default relative flex flex-col items-center justify-center min-h-full p-6 overflow-hidden z-1">
        <GridShape />
        ...
        <p className="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400">
          &copy; {new Date().getFullYear()} - SkyAI
        </p>
      </div>
    </>
  );
